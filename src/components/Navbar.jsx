      ...
      <div className="max-w-7xl mx-auto flex h-14 items-center">
        <div className="md:mr-4 flex justify-between w-full">
          <a href="#" className="mr-6 flex items-center space-x-2">
            <span className="text-2xl font-bold text-primary">Melly Anggraini</span>
          </a>
        ...
        <button 
          className="inline-flex items-center justify-center rounded-md md:hidden active:text-primary" 
